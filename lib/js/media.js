            ...
            if(data["status"]==true){
                ...
                for(var i=0; i<jmlData;i++){
                    ...
                    if(ext=="jpg"||ext=="png"||ext=="gif"||ext=="jpeg"){
                        tabel+="<img src='"+base_url+"uploads/media/icon/"+media[i]["namafile"]+"' class='img img-responsive'>";
                    }else{
                        tabel+="<img src='"+base_url+"uploads/media/icon/"+ext+".png' class='img img-responsive'>";
                    }
