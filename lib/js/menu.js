        ...
        success : function(data){
            ...
            if(data["status"]==true){
                ...
                for(var i=0; i<jmlData;i++){
                    ...
                    tabel+="<td>"+menu[i]["menu_idxsub"]+"</td>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data["status"]==true){
                ...
                if(data["err_menu_idxsub"]!="") $('#err_menu_idxsub').html(data["err_menu_idxsub"]); else $('#err_menu_idxsub').html("");
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if(data["status"]==false){
                ...
                $('#menu_idxsub').val(menu.menu_idxsub);
