function getcontent(start){
    ...
    var limit = $('#limit').val();
    var tipe = $('#tipe').val();
    var url = base_url + "admin/portofolio/data?q=" + search + "&start=" + start + "&limit=" + limit + "&tipe=" + tipe;
    console.clear();
    console.log(url);
    $.ajax({
        url     : url,
        ...
        success : function(data){
            ...
            if(data["status"]==true){
                ...
                for(var i=0; i<jmlData;i++){
                    ...
                    tabel += '<a href=\'' + base_url + 'admin/portofolio/form/'+content[i]["content_id"]+'\' class=\'btn btn-success\'><span class=\'glyphicon glyphicon-pencil\' ></span> Edit</a>';
...
function getMedia(start){
    ...
    var search = $('#q').val();
    var active="class='btn btn-primary btn-sm'";
    var url=base_url + "admin/portofolio/datamedia?q=" + search + "&start=" +start;
    console.log(url);
    $.ajax({
        url     : url,
        type    : "GET",
...
function getDatamedia(id_group){
    ...
    //var search = $('#q').val();
    //var active="class='btn btn-primary btn-sm'";
    var url=base_url + "admin/portofolio/detailmedia/" + id_group;
    //alert(url);
    $.ajax({
        url     : url,
        type    : "GET",
...
function viewMedia(idmedia){
    var url=base_url+"admin/portofolio/viewmedia/"+idmedia;
    $.ajax({
        url : url,
        type: "GET",
        dataType: "HTML",
...
function save(){
    var url;
    url = base_url + "admin/portofolio/save";
    //alert("user");
...
function edit(id)
{
    ...
    $('#form')[0].reset(); 
    $.ajax({
        url : base_url + "admin/portofolio/edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function hapus(id){
    ...
    function(isConfirm){
      if (isConfirm) {
        $.ajax({
            url : base_url + "admin/portofolio/delete/" +id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
...
function setKomentar(id_group){
    if ($('#content_komentar'+id_group).is(':checked')) {
        var url=base_url+"admin/portofolio/komentar/"+id_group+"/1";
    }else{
        var url=base_url+"admin/portofolio/komentar/"+id_group+"/0";
    }
    console.log(url);
    $.ajax({
        url : url,
...
function setStatus(id_group,status){
    var url=base_url+"admin/portofolio/status/"+id_group+"/"+status;
    console.log(url);
    $.ajax({
        url : url,
        type: "GET",
...
function addKategori() {
    var url;
    url = base_url + "admin/portofolio/add_kategori";
    //alert("user");
...
function getKategori(selected) {
    var url = base_url + "admin/portofolio/getkategori";
    console.clear();
    console.log(url);
    $.ajax({
        url: url,
...
function addGroupMedia() {
    var url;
    url = base_url + "admin/portofolio/add_group";
    //alert("user");
