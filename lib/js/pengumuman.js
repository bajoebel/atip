function getcontent(start){
    ...
    var limit = $('#limit').val();
    var tipe = $('#tipe').val();
    var url = base_url + "admin/pengumuman/data?q=" + search + "&start=" + start + "&limit=" + limit + "&tipe=" + tipe;
    console.clear();
    console.log(url);
    $.ajax({
        url     : url,
        ...
        success : function(data){
            ...
            if(data["status"]==true){
                ...
                for(var i=0; i<jmlData;i++){
                    ...
                    tabel += '<a href=\'' + base_url + 'admin/pengumuman/lampiran/' + content[i]["content_id"] + '\' class=\'btn btn-info\'><span class=\'glyphicon glyphicon-paperclip\' ></span>Lampiran</a>';
                    tabel += '<a href=\'' + base_url + 'admin/pengumuman/form/' + content[i]["content_id"] + '\' class=\'btn btn-success\'><span class=\'glyphicon glyphicon-pencil\' ></span> Edit</a>';
...
function getlampiran(pengumumanid) {

    var url = base_url + "admin/pengumuman/data_lampiran/" + pengumumanid;
    console.clear();
    console.log(url);
    $.ajax({
        url: url,
...
function saveLampiran() {
    var url;
    url = base_url + "admin/pengumuman/save_lampiran";
    //alert("user");
...
function editLampiran(id) {
    ...
    $('#form')[0].reset();
    $.ajax({
        url: base_url + "admin/pengumuman/editlampiran/" + id,
        type: "GET",
        dataType: "JSON",
        success: function (data) {
            console.log(data);
            if (data["status"] == false) {
                ...
                if (content.jenis_lampiran == "Gambar") {
                    ...
                    var url = base_url + "admin/pengumuman/allmedia";
                    console.clear();
                    console.log(url);
                    $.ajax({
                        url: url,
...
function viewLampiran(id_group = "") {
    ...
    var url = base_url + "admin/pengumuman/detailmedia/" + id_group;
    //alert(url);
    $.ajax({
        url: url,
        type: "GET",
...
function hapusLampiran(id) {
    swal({
        ...
        function (isConfirm) {
            if (isConfirm) {
                $.ajax({
                    url: base_url + "admin/pengumuman/deletelampiran/" + id,
                    type: "GET",
                    dataType: "JSON",
                    success: function (data) {
                        if (data["status"] == true) {
...
function getMedia(start){
    ...
    var search = $('#q').val();
    var active="class='btn btn-primary btn-sm'";
    var url=base_url + "admin/pengumuman/datamedia?q=" + search + "&start=" +start;
    console.log(url);
    $.ajax({
        url     : url,
        type    : "GET",
...
function viewMedia(idmedia){
    var url=base_url+"admin/pengumuman/viewmedia/"+idmedia;
    $.ajax({
        url : url,
        type: "GET",
        dataType: "HTML",
...
function save(){
    var url;
    url = base_url + "admin/pengumuman/save";
    //alert("user");
    var formData = new FormData($('#form')[0]);
    $.ajax({
        url : url,
...
function edit(id)
{
    ...
    $('#form')[0].reset(); 
    $.ajax({
        url : base_url + "admin/pengumuman/edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function setKomentar(id_group){
    if ($('#content_komentar'+id_group).is(':checked')) {
        var url=base_url+"admin/pengumuman/komentar/"+id_group+"/1";
    }else{
        var url=base_url+"admin/pengumuman/komentar/"+id_group+"/0";
    }
    console.log(url);
    $.ajax({
        url : url,
...
function setStatus(id_group,status){
    var url=base_url+"admin/pengumuman/status/"+id_group+"/"+status;
    console.log(url);
    $.ajax({
        url : url,
        type: "GET",
...
function addKategori() {
    var url;
    url = base_url + "admin/pengumuman/add_kategori";
    //alert("user");
...
function getKategori(selected) {
    var url = base_url + "admin/pengumuman/getkategori";
    console.clear();
    console.log(url);
    $.ajax({
        url: url,
...
function addGroupMedia() {
    var url;
    url = base_url + "admin/pengumuman/add_group";
    //alert("user");
