 ...
 * Custome Config
 */
defined('_DIR_MEDIA_')          OR define('_DIR_MEDIA_', './uploads/media/original');  // Upload Media
defined('_DIR_MEDIA_THUMB_')  OR define('_DIR_MEDIA_THUMB_', './uploads/media/thumb/');  // Upload Media
defined('_DIR_MEDIA_ICON_')   OR define('_DIR_MEDIA_ICON_', './uploads/media/icon/');  // Upload Media


defined('_DIR_PARTNER_ORIGINAL_')        OR define('_DIR_PARTNER_ORIGINAL_', './uploads/partner/original');  // Upload Media
defined('_DIR_PARTNER_THUMB_')  OR define('_DIR_PARTNER_THUMB_', './uploads/partner/thumb/');  // Upload Media
defined('_DIR_PARTNER_ICON_')   OR define('_DIR_PARTNER_ICON_', './uploads/partner/icon/');  // Upload Media
...
defined('_MODE_')          or define('_MODE_', 'non-slider'); //non-slider atau slider