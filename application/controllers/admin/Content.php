...
class Content extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->akses = $this->content_model->getAkses($level);
    }
    ...
    public function index()
    {
        ...
        if (in_array($cek, $this->akses)) {
            ...
            $content = $this->load->view('admin/content/view_index', $data, true);
            $view = array(
                'content'   => $content
            );
        ...
        //header('location:' . base_url() . "admin/content/berita");
    }
