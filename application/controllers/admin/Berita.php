...
class Berita extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->akses = $this->content_model->getAkses($level, 'berita');
    }
        ...
        if(in_array($cek,$this->akses)){
            ...
            if (empty($row)) {
                ...
                if ($this->form_validation->run()) {
                    ...
                    //print_r($array);
                    header('location:' . base_url() . "admin/contenberitat/form");
                    //header('Content-Type: application/json');
                ...
                if ($this->form_validation->run()) {
                    ...
                    header('location:' . base_url() . "admin/berita/form/" . $content_id);
                }
            }
        }
    }
