<div class="col-md-12">
    ...
    ?>
        ...
        <p align="center">
            <img src="<?= base_url() . "uploads/media/original/" . $data->namafile; ?>" class='img img-responsive'>
        </p>
        ...
        <input type="hidden" name="thumb_gambar" id="thumb_gambar" value="<img src='<?= base_url() . "uploads/media/thumb/620X320/_620X320_" . $data->namafile; ?>' class='img img-responsive'>">
        <input type="hidden" name="icon_gambar" id="icon_gambar" value="<img src='<?= base_url() . "uploads/media/thumb/88X88/_88X88_" . $data->namafile; ?>' class='img img-responsive'>">
