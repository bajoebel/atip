            ...
            <div class="panel panel-success">
                <div class="panel-heading ui-draggable-handle">
                    ...
                    if(in_array($save, $akses)){
                        ?>
                        <a href="<?php echo base_url() ."admin/posting/form" ?>" class="btn btn-success btn-sm" ><span class="fa fa-plus"></span> Tambah</a>
                        <?php
                    }
                    ?>
                    </h3>
                    ...
                    <div class="row">
                        <div class="col-xs-9">
                            <div class="text-right">
                                <select class="form-control" style="width: 40px;" id="limit" name='limit' onchange="getPosting(0)">
                        ...
                        <div class="col-xs-3">
                            ...
                            <input type="hidden" name='star' id='star' >
                                <input type="text" name='q' id='q' class="form-control" placeholder='Search' onkeyup="getPosting(0)">
                    ...
                    <form class="form-horizontal" method="POST" id="form" action="#" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            ?>
                                    ...
                                    <span class	ext-error" id="err_id_kategori"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_judul_posting"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_isi_posting"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_tgl_posting"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_tgl_publish"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_tgl_exp"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_group_posting"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_status_posting"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_jml_hits"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class	ext-error" id="err_userinput"></span>
                                </div>
                            </div>
                        </div>
                    </form>
