                        ...
                        <form action="#" method="GET">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-default" onclick="getPengguna(0)"><i class="fa fa-search"></i></button>
                                    <?php 
                                    $excel=array('aksi'=>'Excel');
                                    $pdf=array('aksi'=>'Pdf');
                                    if(in_array($excel, $akses)){
                                        ?>
                                        <a href="<?php echo base_url() ."pengguna/exel" ?>" class="btn btn-success btn-sm"><span class="fa fa-file-excel-o"></span></a>
                                        <?php
                                    }
                                    if(in_array($pdf, $akses)){
                                        ?>
                                        <a href="<?php echo base_url() ."pengguna/pdf" ?>" class="btn btn-danger btn-sm"><span class="fa fa-file-pdf-o"></span></a>
                                        <?php
                                    }
                                    ?>
                                </div>
                ...
                <div class="modal-body form">
                    <form class="form-horizontal" method="POST" id="form" action="#" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <input type="hidden" class="form-control" id="ref_id" name="ref_id" placeholder="Refid">
                            <input type="hidden" class="form-control" id="group_user" name="group_user" value="Admin" placeholder="group_user">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Role Akses</label>
                                <div class="col-sm-9">
                            ...
                            ?>
                                    ...
                                    <span class	ext-error" id="err_group_user"></span>
                                </div>
                            </div>
                            <div class="form-group">
...
<script src="<?php echo base_url() ."js/pengguna.js"; ?>"></script>